...
1. **Reading level**: Flesch-Kincaid grade 7 or below — this is CRITICAL and will be machine-checked. Write as if explaining to a 12-year-old. Aim for 10-12 words per sentence. Use 1-2 syllable words ("use" not "utilize", "help" not "facilitate", "show" not "demonstrate", "get" not "obtain", "stop" not "prevent", "find" not "identify", "check" not "examine", "body" not "organism", "shot" not "vaccination"). No sentence should exceed 20 words. Break ALL complex ideas into multiple short sentences. NEVER use academic phrasing — say "studies show" not "evidence suggests", "research found" not "research indicates", "meant to" not "designed to". Avoid passive voice. Avoid words with 4+ syllables whenever a simpler word works.
